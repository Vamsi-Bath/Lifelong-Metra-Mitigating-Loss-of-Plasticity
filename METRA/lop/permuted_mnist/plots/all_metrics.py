...
def add_cfg_performance(cfg='', setting_idx=0, m=2*10*1000, num_runs=30, metric='accuracy'):
    ...
    for idx in range(num_runs):
        ...
        if metric == 'weight':
            ...
            # Average invariance across hidden layers
...
def main(arguments):
    ...
    parser.add_argument(
        '--metric',
        help="Specify the metric you want to plot, the options are: accuracy, weight, dead_neurons, effective_rank, and invariance",
        type=str,
        default='accuracy'
    )
