...
def get_argparser():
    ...
    parser.add_argument('--n_epochs_per_eval', type=int, default=20)
    parser.add_argument('--n_epochs_per_log', type=int, default=25)
    parser.add_argument('--n_epochs_per_save', type=int, default=10)
    parser.add_argument('--n_epochs_per_pt_save', type=int, default=10)
    parser.add_argument('--n_epochs_per_pkl_update', type=int, default=25)
    parser.add_argument('--num_random_trajectories', type=int, default=28)
...
def build_runner_and_algo(args, ctxt=None, mode=None, cp_path=None):
    ...
    # In hierarchical mode, trust the saved child-policy checkpoint.
